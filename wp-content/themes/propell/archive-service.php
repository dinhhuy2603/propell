                    ...
                    <?php while ($service_query->have_posts()) : $service_query->the_post(); ?>
                        ...
                        <div class="c-toggle">
                            ...
                            <div class="c-toggle__main">
                                <div class="container">
                                    <a href="<?php echo esc_url($current_home_url.'categories') ?>" class="c-learn-more">VIEW OUR PROJECTS</a>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="photo01">
                                                ...
                                                <?php if (count($image_ids_array) > 0) : ?>
                                                    <img src="<?php echo wp_get_attachment_url($image_ids_array[0]) ?>" alt="">
                                                <?php endif; ?>
                                            </div>
                                        </div>
<!--                                            <div class="photo01"><img src="--><?php //echo wp_get_attachment_url($image_ids_array[0]) ?><!--" alt=""></div>-->
                                        <div class="col">
                                            <div class="photo02">
                                                <!--                                            <picture>-->
                                        ...
                                        <div class="col">
                                            <?php if (count($image_ids_array) > 2) : ?>
                                                <div class="photo03"><img src="<?php echo wp_get_attachment_url($image_ids_array[2]) ?>" alt=""></div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
